...
1.1) Open your browser and go to portal.azure.com
...
3.4) Try these commands to verify your setup:
     az account show          (displays your current subscription)
     az group list --output table   (lists your resource groups in a table format)
